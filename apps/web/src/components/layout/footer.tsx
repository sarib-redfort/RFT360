 ...
 * connect), collapsing to two columns on tablet and one on mobile. Content is CMS-driven
      ...
      <div className="container-rft relative py-16 md:py-20">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr_1.2fr] lg:gap-12">
          ...
          <div>
            ...
            {/* Social channels are listed by name, as in the source copy —
                icon-only tiles read as decoration rather than a link list. */}
              ...
              {links.map((link) => (
                <li key={link.label}>
                  <a
                    ...
                    className="tap-link inline-flex items-center gap-2.5 text-[0.875rem] text-[var(--text-secondary)] transition-colors hover:text-[var(--accent)]"
                  >
                    <Icon name={link.icon} className="w-4 text-[0.8rem] text-[var(--text-muted)]" />
                    {link.label}
                  </a>
                </li>
              ))}
                ...
                <li>
                  ...
                  >
                    <Icon
                      ...
                      className="w-4 text-[0.8rem] text-[var(--text-muted)]"
                    />
                    {settings.contactEmail}
                  </a>
                </li>
